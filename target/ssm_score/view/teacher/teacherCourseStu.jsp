                ...
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                <li class="active"> <a href="${pageContext.request.contextPath}/teacher/myCourseStu">课程学生</a> </li>
                        ...
                        <div class="card">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="teacher" items="${requestScope.get('teachers')}" >
                                            <tr>
                                                ...
                                                <td>${teacher.profession.p_name}</td>
                                                <td>${teacher.faculty.f_name}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                            ...
                            <ul class="pagination">
                                ...
                                <li>
                                    ...
                                    <a href="${pageContext.request.contextPath}/teacher/myCourseStu?currentPage=${pb.currentPage-1}&rows=10&sname=${sname}&sid=${sid}" aria-label="Previous">
                                ...
                                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                                    <c:if test="${pb.currentPage == i}">
                                        <li class="active"><a href="${pageContext.request.contextPath}/teacher/myCourseStu?currentPage=${i}&rows=10&sname=${sname}&sid=${sid}"> ${i}</a></li>
                                    </c:if>
                                    <c:if test="${pb.currentPage != i}">
                                        <li><a href="${pageContext.request.contextPath}/teacher/myCourseStu?currentPage=${i}&rows=10&sname=${sname}&sid=${sid}"> ${i}</a></li></li>
                                    </c:if>
                                </c:forEach>
                                <%----%>
                                ...
                                <li>
                                    ...
                                    <a href="${pageContext.request.contextPath}/teacher/myCourseStu?currentPage=${pb.currentPage+1}&rows=10&sname=${sname}&sid=${sid}" aria-label="Next">
