            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 学生信息-添加学生 </span>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="card">
                                        <span style="color: red;font-weight:bold">${error_class}</span>
                                        <div class="card-header"><h4>添加学生</h4></div>
                                        <div class="card-body">

                                            <form action="${pageContext.request.contextPath}/admin/addStu" method="post">
                                                <%-- 隐藏域ID--%>
                                                ...
                                                <div class="example-box"  style="text-align: center">
                                                    ...
                                                    <label for="p_id">专业选择</label>
                                                    <select class="form-control"  id="p_id" name="p_id">
                                                        <option value="-1">请选择专业</option>
                                                    </select>

                                                    <label for="cl_id">班级选择</label>
                                                    <select class="form-control"  id="cl_id" name="cl_id">
                                                        <option value="-1">请选择班级</option>
                                                    </select>--%>


                                                    <span style="color: red;font-weight:bold">${error_repeat}</span>
                                                <div class="form-group">
