                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="course" items="${requestScope.get('courses')}" >
                                            <tr>
                                                ...
                                                <td> <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath}/admin/toUpdateCourse?c_id=${course.c_id}&c_name=${course.c_name}&t_name=${course.teacher.t_name}&t_id=${course.teacher.t_id}&credit=${course.credit}" title="编辑" data-toggle="tooltip"><i class="ftsucai-edit-2"></i></a>
