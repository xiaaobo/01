                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href="${pageContext.request.contextPath}/stu/queryRankByCname?currentPage=1&rows=10">科目成绩排行</a> </li>
                            </ul>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 班级成绩排行-科目成绩排行 </span>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-toolbar clearfix">
                                <%--按课程名称查询--%>
                                <form class="pull-right search-bar" method="post" action="${pageContext.request.contextPath}/stu/queryRankByCname?currentPage=1&rows=10&" role="form">
                            ...
                            <ul class="pagination">
                                ...
                                <li>
                                    ...
                                    <a href="${pageContext.request.contextPath}/stu/queryRankByCname?currentPage=${pb.currentPage-1}&rows=10&cname=${cname}" aria-label="Previous">
                                ...
                                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                                    <c:if test="${pb.currentPage == i}">
                                        <li class="active"><a href="${pageContext.request.contextPath}/stu/queryRankByCname?currentPage=${i}&rows=10&cname=${cname}"> ${i}</a></li>
                                    </c:if>
                                    <c:if test="${pb.currentPage != i}">
                                        <li><a href="${pageContext.request.contextPath}/stu/queryRankByCname?currentPage=${i}&rows=10&cname=${cname}"> ${i}</a></li></li>
                                    </c:if>
                                </c:forEach>
                                <%----%>
                                ...
                                <li>
                                    ...
                                    <a href="${pageContext.request.contextPath}/stu/queryRankByCname?currentPage=${pb.currentPage+1}&rows=10&cname=${cname}" aria-label="Next">
