            ...
            <div class="ftdms-layout-sidebar-scroll">
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <ul class="nav nav-subnav">
                            <li class="active"> <a href="${pageContext.request.contextPath}/stu/stuSumRank?currentPage=1&rows=10">平均分排行</a> </li>
                            ...
                            <ul class="pagination">
                                ...
                                <c:if test="${pb.currentPage!=1}">
                                    <li>
                                       ...
                                       <a href="${pageContext.request.contextPath}/stu/stuSumRank?currentPage=${pb.currentPage-1}&rows=10" aria-label="Previous">
                                ...
                                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                                    <c:if test="${pb.currentPage == i}">
                                        <li class="active"><a href="${pageContext.request.contextPath}/stu/stuSumRank?currentPage=${i}&rows=10"> ${i}</a></li>
                                    </c:if>
                                    <c:if test="${pb.currentPage != i}">
                                        <li><a href="${pageContext.request.contextPath}/stu/stuSumRank?currentPage=${i}&rows=10"> ${i}</a></li></li>
                                    </c:if>
                                </c:forEach>
                                <%----%>
                                ...
                                <c:if test="${pb.currentPage!=pb.totalPage}">
                                    ...
                                    <a href="${pageContext.request.contextPath}/stu/stuSumRank?currentPage=${pb.currentPage+1}&rows=10" aria-label="Next">
