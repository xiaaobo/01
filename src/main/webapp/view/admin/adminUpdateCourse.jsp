            ...
            <div class="ftdms-layout-sidebar-scroll">
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item active"> <a href="${pageContext.request.contextPath}/admin/courses"><i class="ftsucai-UI"></i>课程信息</a> </li>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 课程信息-修改课程 </span>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="card">
                                        <div class="card-header"><h4>修改课程</h4></div>
                                        <div class="card-body">

                                            <form action="${pageContext.request.contextPath}/admin/updateCourse" method="post">
                                                <input type="hidden" name="c_id" value="${c_id}"> <input type="hidden" name="oldCourseName" value="${c_name}">
                                                ...
                                                <div class="form-group">
                                                    <label for="credit">学分设置</label>
                                                    <select class="form-control" id="credit" name="credit">
                                                        <option value="${credit}">${credit}</option>
                                                        <c:if test="${!credit.equals('4.0')}">
                                                            <option value="4">4.0</option>
                                                        </c:if><c:if test="${!credit.equals('3.0')}">
                                                            <option value="3">3.0</option>
                                                        </c:if><c:if test="${!credit.equals('2.0')}">
